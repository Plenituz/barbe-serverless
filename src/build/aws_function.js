  ...
  function awsFunctionIterator(bag) {
    ...
    let databags = [
      ...
      cloudResource("aws_lambda_function", `${bag.Name}_lambda`, {
        ...
        handler: packageType === "Image" ? void 0 : block.handler || void 0,
        runtime: packageType === "Image" ? void 0 : block.runtime || void 0,
        ...
        source_code_hash: block.override_source_code_hash || (packageType === "Zip" ? asFuncCall("filebase64sha256", [packageLocation]) : void 0),
