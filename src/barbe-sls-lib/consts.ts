...
export const AWS_CLOUDFRONT_FOR_S3 = 'aws_cloudfront_for_s3'
...
export const AWS_ECR_REPOSITORY_WITH_IMAGE = 'aws_ecr_repository_with_image'
...
export const AWS_ECR_REPOSITORY_WITH_IMAGE_URL = `barbe-serverless/aws_ecr_repository_with_image.js:${BARBE_SLS_VERSION}`